...
define([
  ...
  'dojo/date/stamp'
], function (registerSuite, chai, chaiAsPromised, assert, require, request,
       Deferred, mongoose, util, stamp) {
  ...
  //            _id = res.body[0]._id;
      ...
      'retrieves an object': function(done) {
        return beforeEachDfd.then(function() {
