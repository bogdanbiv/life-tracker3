 ...
 */
define(['intern!object', 'intern/chai!assert', "dojox/calendar/ColumnView", "dojox/calendar/MatrixView",
    "dojo/store/Memory", "dojo/store/Observable" ],
    function(registerSuite, assert, ColumnView, MatrixView, Memory, Observable){
        registerSuite({
            name: "itemEditing",
            ...
            "#MoveNoSnap": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 7)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 7)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 4)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 4)), 0);
            ...
            "#MoveSnap": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 0)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 0)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 15)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 15)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#ResizeNoSnap": function() {
                var item = {	id:0, startTime: new Date(2011, 0, 5, 10), endTime: new Date(2011, 0, 5, 11) };
                var data = [ item ];
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 9, 53)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 9, 53)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 8)), 0); // 7 + 1 as end is moved
            ...
            "#ResizeSnap": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 9, 50)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 9, 50)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 11, 10)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#ResizeMinDurationColumnView": function() {
                var item = {	id:0, startTime: new Date(2011, 0, 5, 10), endTime: new Date(2011, 0, 5, 11) };
                var data = [ item ];
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 5, 10, 15)), 0);
            ...
            "#MoveAllDay": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 6)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 6)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7)), 0);
            ...
            "#ResizeStartAllDay": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 4)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 6)), 0);
            ...
            "#MoveNoSnapMatrixView": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 7)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7, 11, 7)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 4)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7, 11, 4)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#MoveSnapMatrixView": function() {
                var item = {	id:0, startTime: new Date(2011, 0, 5, 10), endTime: new Date(2011, 0, 7, 11) };
                var data = [ item ];
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 5)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7, 11, 5)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10, 0)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7, 11, 0)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#MoveRoundToDayMatrixView": function() {
                var item = {	id:0, startTime: new Date(2011, 0, 5, 10), endTime: new Date(2011, 0, 7, 11) };
                var data = [ item ];
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 10)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 7, 11)), 0);
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 6, 10, 0)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 8, 11, 0)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#MoveLabelMatrixView": function() {
                var item = {	id:0, startTime: new Date(2011, 0, 5, 10), endTime: new Date(2011, 0, 5, 11) };
                var data = [ item ];
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 6, 10, 0)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 6, 11, 0)), 0);

                o.validateRendering();
                o.destroyRecursive();
            },

            "#ResizeMinDurationMatrixView": function() {
                ...
                assert.equal(cal.compare(item.startTime, new Date(2011, 0, 5, 6)), 0);
                assert.equal(cal.compare(item.endTime, new Date(2011, 0, 6, 6)), 0);
